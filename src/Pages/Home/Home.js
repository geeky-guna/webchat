        ...
        <div class="content-wrapper">
          ...
          <div class="AppfeaturesFounder">
            ...
            <div class="pure-u-1 pure-u-md-1-2 pure-u-lg-3-5">
              <h2 class="content-head content-head-ribbon">GuNa Skr</h2>

              <p style={{ color: "white" }}>The Student of Gitam University.</p>
              <p style={{ color: "white" }}>
                Currently studying final year MCA and simultaneously working as an <b>Application Developer</b> at HP
              </p>
            </div>
          </div>
